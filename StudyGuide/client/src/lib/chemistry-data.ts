export interface Element {
  ...
  atomicNumber: number;
  atomicMass: string;
  category: 'nonmetal' | 'noble-gas' | 'alkali-metal' | 'alkaline-earth-metal' | 'metalloid' | 'halogen' | 'transition-metal' | 'post-transition-metal' | 'lanthanide' | 'actinide';
}
...
export const elementsData: Element[] = [
  ...
  { symbol: 'Be', name: 'Beryllium', atomicNumber: 4, atomicMass: '9.012', category: 'alkaline-earth-metal' },
...
export const moleculesData: Molecule[] = [
  ...
  },
  {
    ...
    bondAngle: '109.5°',
    description: 'A nonpolar molecule with four hydrogen atoms bonded to carbon'
  },
  {
    name: 'Ammonia',
    formula: 'NH₃',
    ...
    bondAngle: '107°',
    description: 'A polar molecule with three hydrogen atoms bonded to nitrogen'
  },
  {
    name: 'Carbon Dioxide',
    formula: 'CO₂',
...
export const formulaSheetData = [
  ...
  },
  {
    ...
    formulas: [
      ...
      { name: 'Molarity', formula: 'M = mol solute/L solution', description: 'Concentration in moles per liter' }
    ]
  }
];
